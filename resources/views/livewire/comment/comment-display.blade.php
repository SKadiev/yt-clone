                        ...
                        <div>
                            <div class="d-flex text-gray">
                                <div class="d-flex align-items-center">
                                    <span wire:click.prevent="likeComment" class="material-icons" style="font-size: 2rem;cursor: pointer">thumb_up</span>
                                    <span class="mx-2" >{{$likes}}</span>
                                    <span wire:click.prevent="dislikeComment" class="mx-2 material-icons" style="font-size: 2rem; cursor: pointer">thumb_down</span>
